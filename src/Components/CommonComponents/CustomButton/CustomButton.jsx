...
export default function CustomButton({bgColor,text, textColor,border,hvBgColor,hvtextColor, title, mb}) {
  ...
  return (
    <div>
        <button type="button" className={`flex  py-[15px] ${mb} px-[40px] items-center ${bgColor} ${text} text-[13px] text-sm font-['Roboto', 'sans-serif'] focus:outline-none rounded-lg border-2 font-bold ${border} ${hvBgColor} ${hvtextColor} uppercase`} >
       {title}
